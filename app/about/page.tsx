...
export const metadata = {
  title: "About Us",
  description: "Learn more about The Wild Oasis and our family legacy.",
};

export default function Page() {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center overflow-y-auto no-scrollba">
