    ...
    <div className="scale-[1.01]">
      ...
      <form className="bg-primary-900 py-8 sm:py-10 px-6 sm:px-12 lg:px-16 text-base sm:text-lg flex gap-5 flex-col">
        ...
        <div className="flex flex-col sm:flex-row justify-end items-stretch sm:items-center gap-4 sm:gap-6">
          ...
          <button className="bg-accent-500 px-6 sm:px-8 py-3 sm:py-4 text-primary-800 font-semibold hover:bg-accent-600 transition-all disabled:cursor-not-allowed disabled:bg-gray-500 disabled:text-gray-300 w-full sm:w-auto">
            Reserve now
          </button>
        </div>
      </form>
